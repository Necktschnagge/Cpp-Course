...
Wenn exakte Breiten (oder eine Mindestbreite) bestimmter Typen für Sie unerlässlich sind, können Sie mit \texttt{\#include <cstdint>} eine Bibliothek importieren, die Typen fester Breite (und vieles mehr) zur Verfügung stellt:
...
%\begin{framed}
%\fbox{
\begin{mdframed}[rightmargin=70pt, leftmargin=70pt]
...
%### how to ceter a rail diagram ????
\begin{multicols}{2}
\begin{rail}
	NoDigit : '\_' | 'a,b,...,z' | 'A,B,...,Z';
	IdentSign : NoDigit | ('0,1,...9');
	Identifier : NoDigit (() + IdentSign);
\end{rail}
