...
\begin{tabu}{X[-1,c]|X[c]|X[c]|X[5,c]|}
	\tabucline{2-}
	& \textbf{Typ} & \textbf{Synonym} & \textbf{Größe} \\ \tabucline{2-}
	& & & \textsl{Datenmodelle bzw. Programmiermodelle} \\ \
	& & & \begin{tabu}{ccccc}
		& & & WIN & unixoide, Mac  
	\end{tabu} \\ \tabucline{4-}
	...
	\end{tabu} \\ \tabucline{2-}
	& \texttt{short int} & \texttt{short} & \begin{tabu}{c|c|c|c|c|c|c}
